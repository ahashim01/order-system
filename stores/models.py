...
class Stores(ModelBase):
    ...
    custom_identifier = models.TextField()
    shipping_tax_status = models.BooleanField(default=False,null=True, blank=True)
    store_type = models.ForeignKey("StoreTypes", models.CASCADE)   
...
class Customers(ModelBase):
    ...
    store_type = models.ForeignKey(StoreTypes, models.PROTECT)
    store_type_id = models.TextField()
